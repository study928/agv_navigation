...
class WpNavi():
    ...
    def way_point(self):        
        ...
        while not rospy.is_shutdown():
            ...
            self.goal.target_pose.pose.position.x = waypoints[i][0]
            self.goal.target_pose.pose.position.y = waypoints[i][1]

            self.goal.target_pose.pose.orientation = Quaternion(0, 0,waypoints[i][5],waypoints[i][6])
...
if __name__ == '__main__':
    ...
    rospy.init_node('pose_navigation')
    w = WpNavi()
